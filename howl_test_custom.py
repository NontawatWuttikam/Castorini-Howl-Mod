...
class HowlClientCustom:
    ...
    def load_model(self, path: str, force_reload: bool = False):
        ...
        print("Engine threshold: ", self.engine.threshold)
        self.ctx = ctx
        print("CONTEXT")
        print("CONTEXT",dump(ctx))
        print("engine")
        print("engine",dump(self.engine))
...
client.load_model("//media/nontawat/Windows/wakeword_ws/howl_/howl/workspaces/hello-cape-bee-res8-reproduce-neg-talknoise-200k", force_reload=False)
